            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.authority.label" default="Authority" /></td>
                            
                            <td valign="top" class="value">${userInstance?.authority?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.favoris.label" default="Favoris" /></td>
